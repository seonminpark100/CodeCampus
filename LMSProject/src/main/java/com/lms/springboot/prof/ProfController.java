...
//	강의 업로드 관리
	@GetMapping("/prof/lectureList.do")
	public String letureBoardList(@RequestParam("lectureCode") String lecture_code, Model model, HttpServletRequest req, ProfDTO profDTO) 
	{
