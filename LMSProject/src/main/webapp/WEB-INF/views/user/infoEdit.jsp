	...
	<body>
		<div class="container" style="text-align:left; max-width: 100%;">
		    ...
		    <div class="m-3 p-3 border border-3 border-warning rounded" style="height: 540px; text-align: center;">
			    <h3>정보 수정</h3>	  
			    <form action="infoEdit.do" method="post">
		    		...
		    		<div class="form-floating w-25 bordered border-3 border-primary" style="margin-left: 38%; margin-top: 2%;">
						<input type="password" class="form-control" id="user_pw" name="user_pw" placeholder="PASSWORD" value="${ dto.user_pw }" required>
						<label for="pass">패스워드</label> 
			    	</div>
		    		<div class="form-floating w-25 bordered border-3 border-primary" style="margin-left: 38%; margin-top: 2%;">
						<input type="password" class="form-control" id="user_pw_check" name="user_pw_check" placeholder="PASSWORD" value="${ dto.user_pw }" required>
