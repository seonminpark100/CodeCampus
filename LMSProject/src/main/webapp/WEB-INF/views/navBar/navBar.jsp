				    ...
				    <c:when test="${not empty principal}">  <!-- "$ 띄어쓰기 하면 절대안됨 -->
						...
						<div class="collapse navbar-collapse" id="navbarNavDropdown">
							<ul class="navbar-nav">
								...
								<li class="nav-item"><a class="nav-link" href="/user/lmsBoard.do">커뮤니티</a>
								</li>
						...
						<div class="d-flex">
					        <span style="color: white; font-size: 1.5em; font-weight: bold;">${ principal.username }님&nbsp;&nbsp;</span>
					        <button class="btn btn-success" type="button" onclick="location.href='myPage.do'">마이페이지</button>
