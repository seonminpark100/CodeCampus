...
<div class="container">
    <div>
        <h3>관리자 시스템</h3>
        <ul>
            AdminController의 매핑 경로에 맞춰 수정
            <li><a href="<c:url value='/admin/admin_user_management.do'/>" class="active">회원 관리 화면</a></li>
    ...
    <div class="main-content">
        ...
        <div class="form-section">
            <h2>새 회원 계정 생성</h2>
            AdminController의 클래스 레벨 매핑에 따라 /admin/create로 수정
